...
( function() {
    ...
    function init_conf()
    {
        ...
        [
			...
			{ xP : { pcolor : proofOnlyVisibleWhenHighlighted,
				cssClass: 'subessay--solution',
			 },},
            { EP : { pcolor : proofOnlyVisibleWhenHighlighted, 
				cssClass: 'logic_phase--proof',
			},},
            { ES : { pcolor : proofOnlyVisibleWhenHighlighted, 
				cssClass: 'logic_phase--proof',
			},},
            { EI : { pcolor : proofOnlyVisibleWhenHighlighted,
				cssClass: 'subessay--solution',
			 },},
            { EC : { pcolor : proof, 
				cssClass: 'logic_phase--proof',
            ...
            { PI : { pcolor : proofOnlyVisibleWhenHighlighted,
				cssClass: 'subessay--solution',
			 },},
