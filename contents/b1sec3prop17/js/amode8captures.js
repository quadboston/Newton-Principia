( function() {
    ...
    {
        //console.log('amode8captures.js amode2rgstate'); //called 2x on page load, then once more when switching tabs
        ...
        if( amode.subessay === 'corollary3' || amode.subessay === 'corollary4' ){
            var imgVisib = 'hidden';
            //// scholium
            rg.omegaHandle.hideD8Dpoint = true;
            rg[ 'P,omegaHandle' ].undisplay = true;
        ...
        if( logic_phase === 'corollary' && amode.subessay === 'corollary2' ){
            ...
            //todo: what is sop? this is where the incorrect but unused e values are comming from
            //console.log(sop.initialEccentricity)
