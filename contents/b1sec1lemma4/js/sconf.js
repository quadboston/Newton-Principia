...
var {eachprop, nspaste, fconf, sf, sconf, tpid2arrc_elect, ssD,
     tpid2arrc_repo, originalPoints,} =
...
function init_conf (){
    ...
    var realSvgSize = 1.5 * ( pictureWidth + pictureHeight ) / 2;
    ...
    */
    ...
    var mod2med = ( originalPoints.A.pos[1] - originalPoints.a.pos[1] );
