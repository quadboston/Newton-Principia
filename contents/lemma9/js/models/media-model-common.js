( function() {
    ...
    function media_upcreate()
    {
        ...
        var pointA     = pos2pointy4lemma9( 'point-A',  null
                                      , 'skipSVG'
                                    );
        var pointD     = pos2pointy4lemma9( 'point-D', null
                                      , 'skipSVG'
                         );
        var pointE     = pos2pointy4lemma9( 'point-E',  null
                          , 'skipSVG'
                          );
        var pointB     = pos2pointy4lemma9( 'point-B',  null
                          , 'skipSVG'
                          );
        var pointC     = pos2pointy4lemma9( 'point-C',  null
                          , 'skipSVG'
                         );
        ...
        //does drag points
        doPaintCore( 'point-E', sDomF.getFixedColor( 'given' ) );
        doPaintCore( 'point-B', sDomF.getFixedColor( 'given' ) );
        doPaintCore( 'point-C', sDomF.getFixedColor( 'given' ) );
        doPaintCore( 'pivotPoint1', sDomF.getFixedColor( 'given' ), mainCurve.mediael.pivotPoints[1] );
        doPaintCore( 'pivotPoint2', sDomF.getFixedColor( 'given' ), mainCurve.mediael.pivotPoints[2] );
        //==========================================
        // \\// paints points over diagram
        //==========================================
        ...
        function doPaintCore( pName, borderColor, rgX )
        {
            var pNameC          = pName + '-core';
            var ptC             = ssF.toreg( pNameC )();
            ptC.pos             = ( rgX || rg[ pName ] ).pos;
            ptC.medpos          = ( rgX || rg[ pName ] ).medpos;
            pos2pointy4lemma9( pNameC,
                {
                    'fill' : '#ffffff',
                    stroke : borderColor,
                    'stroke-width' : 0.5
        ...
        function pos2pointy4lemma9( pName, attrs, skipSVG, customSWidth, medPosKnown )
        {
            ...
            pt.svgel = sv.u({
                ...
                //r : 4 * sconf.thickness
                r : ( customSWidth || 0.7 ) * sconf.thickness
            });
