...
( function() {
    ...
    function init_conf()
    {
        ...
        var predefinedTopics =
        {
            ...
            curvature,
            body,
            orbit : p17_result_orbit,//p17_result_given,
            'orbit-sample' : given,
            orbitarea: (fconf.effId === "b1sec3prop14" ? orbitarea2 : orbitarea),
            'orbitarea-sample' : orbitareaSample,
            orbitdq : p17_result_orbit,//p17_result_given,
            'orbitdq-sample' : given, //todm remove
            shadow,
            force   : p17_force_result,
            instanttriangle: (fconf.effId === "b1sec3prop14" ? instanttriangle2 : instanttriangle),
