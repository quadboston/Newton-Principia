(function () {
  ...
  function amode2rgstate(captured) {
    ...
    if (fconf.sappId === "b1sec1lemma6") {
      ...
      if (theorion === "proof" || theorion === "claim") {
        sDomF.detected_user_interaction_effect("doUndetected");
        ["curve-AB", "AD"].forEach((gname) => {
          rg[gname].undisplay = false;
        });
      ...
      if (
        ...
        ["arc-Ab", "Ab", "b", "d", "Ad", "r", "rd", "dr"].forEach((gname) => {
          rg[gname].undisplay = false;
        });
    ...
    if (fconf.sappId === "b1sec1lemma7") {
      ...
      if (amode.subessay === "vector-derivative") {
        ["arc-Ab", "Ad", "b"].forEach((gname) => {
          rg[gname].undisplay = false;
        });
      }
      ...
      if (theorion === "corollary") {
        ["curve-AB", "left-curve-AB", "arc-AB", "AD", "BD", "D", "C"].forEach(
          (gname) => {
            rg[gname].undisplay = false;
          }
        );
        ...
        ns.paste(rg.curveStart.pos, [-0.2, 0]);
        ns.paste(rg.curveEnd.pos, [ssD.curveEndInitialPos[0], 0]);
        ["C", "D", "BD", "AD", "curve-AB"].forEach((gname) => {
          rg[gname].undisplay = false;
        });
    ...
    if (fconf.sappId === "b1sec1lemma8") {
      ...
      ["D", "R", "C", "AR", "AD", "BD", "BR", "RD", "curve-AB", "fi"].forEach(
        (gname) => {
          rg[gname].undisplay = false;
        }
      );
