( function () {
    ...
    function constructsRects_tillExtraOffset_parlessDom(dr)
    {
...

        {
            ...
            let classStyle = "tp-inscribed-rectangles";
            let classPrefixSingle = null;
            const lowname = stdMod.generateFigureName?.(dr);
            if (lowname) {
                classStyle += `-${lowname}`;
                classPrefixSingle = `tp-inscribed-rectangle-${lowname}-`;
            }
