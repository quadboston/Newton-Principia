( function() {
    ...
    function model_upcreate()
    {
        ...
        {
            let rgid = 'ICK';
            let graph = sData.quadSolved.borbit;
            let rgX = toreg( rgid )( 'rgid', rgid )();
        ...
        pivots2graph( 'IK', sData.quadSolved.borbit, iqE, iqD, 'stroke' );
    ...
    function pivots2graph( rgid, graph, lastIq, firstIq, fill0stroke )
    {
        //alternates
    ...
    function buildsQuadPlot( rgX, fill0stroke )
    {
        ...
        //:paints colors
        var lowname = sDomF.rgid2low( rgX.rgid );
