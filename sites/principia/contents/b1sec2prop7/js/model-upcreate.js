...
const {
        ...
        fconf, sData, flagdo, userOptions, ssF,
        ssD, stdMod, amode, sconf, rg, toreg,
...
function model_upcreate (){
    ...
    const rgCurve = rg.borbit;
    const fun = rgCurve.dyn_q2xy;
    common_fun = fun;
    ...
    if( ssD.PdragInitiated || ssD.SdragInitiated ) {
        ...
        var { rplus, rminus, sidePlus, sideMinus, qplus,
              qminus, Qparams, dt2dq, dt } =
        ...
        */
        let chord = rg.chord =
            [ sidePlus[0] - sideMinus[0],
                sidePlus[1] - sideMinus[1], ];
    ...
    // \\// stashes rollback data
    //-----------------------------------------
    var sagitta2 = [ sidePlus[0] + sideMinus[0],
                        sidePlus[1] + sideMinus[1], ];
    ...
    var RCmedpos = ssF.modpos2medpos( RC, );
    ...
    var Gcol2 = mat.linesCross(
        [ rg.Rcol2.pos[0]-rg.P.pos[0], rg.Rcol2.pos[1]-rg.P.pos[1] ],
        //direction-1
        rg.S.pos,  //start-1
        uu, //direction-2'
        rg.P.pos  //start-2'
    ...
    if( flagdo.solvable_orbit ) {
        if( ssD.stashedVisibility ) {
            ...
            let nssvg = ssD.stashedVisibility;
        ...
        ssD.stashedVisibility = {
            ...
            //***********************************
            //we do comment them because of do
            //plan build solution not depending on
            //solvability gaps solution which
            //always exists,
            //we will not need stashing,
            //************************************
            //todo     //'APQ'                   : rg.APQ.undisplay,
