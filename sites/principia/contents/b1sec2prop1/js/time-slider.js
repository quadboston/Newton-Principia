(function(){
const {sn, $$, nssvg, globalCss, haz, nspaste, sconf,
...
function creates_sliderDomModel__4__time (){
    ...
    var COLOR = sDomF.rgid0arrc_2_rgba( sliderId );
    ...
    //-------------------------------------------------------------
    var startX            = ( -sconf.medposOfModOrigin_x +
    ...
    var endX              = startX + sconf.innerMediaWidth *
                                        ...
                                        sconf.med2mod;
    var startY            = sconf.medposOfModOrigin_y
    ...
    function upates_timeSlider8unmasksSvg (){
        var rawTime = rgX[ apiValueName ]; //===rg.sl-rgid-time.curtime;
...
function processDownEvent( arg ){
    this.achievedtop.achieved = this.curtime;
}
...
function move2updates( move_in_model ){
    ...
    var newTime = rgX.achievedtop.achieved +
        move_in_model[ 0 ] /
        rgX.railsLength *
        sconf.timeRange;
    //sets value:
...
function slTime_2_stepIndice8tCaption (){
    var sp8ep = haz( rg, 'sl-rgid-time' );
    var ctime = rg['sl-rgid-time'].curtime;
