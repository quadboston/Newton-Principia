( function() {
    ...
    function attach_graph_methods ( graph_wrap, graph_methods ){
        ...
        graph_wrap.createsToolLineConfig = createsToolLineConfig;
        ...
        function makes_pix2color (){
            let pix2color = [
                sDomF.rgid0arrc_2_rgba( 'proof' ),
                sDomF.rgid0arrc_2_rgba( 'borbit' ),
                sDomF.rgid0arrc_2_rgba( 'force' ),
                sDomF.rgid0arrc_2_rgba( 'semiaxes' ),
            ];
