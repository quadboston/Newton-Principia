(function(){
const { ns, nspaste, fconf, stdMod, stripp,
        sconf, sf, tpelect,
...
function init_conf (){
    ...
    var medWidth = 690; //841;
    var medHeight = 836; //728;
    ...
    sconf.nonhover_width = Math.max( 1, Math.floor(
                           1*medsizeScale/1.6 ) );
    sconf.hover_width = Math.max( 2, Math.floor(
                        7*medsizeScale/1.6 ) );
