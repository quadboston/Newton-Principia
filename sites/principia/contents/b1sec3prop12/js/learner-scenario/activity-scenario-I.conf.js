( function() {
    ...
    arios.push(( function () {
        ...
        sScript.scenarioScript = `
            ...
            || start
                + lesson-start
                    :1. When ¦P,vb¦<b>initial speed</b>¦¦ increases, which shape ¦borbit¦<b>orbit</b>¦¦ takes? (Ellipse, hyperbola, parabola?)<br><br>Verify your idea ¦vb¦<b>by dragging</b>¦¦ value ¦P,vb¦<b>of v</b>¦¦.<br><br>2. Advanced: Why? Prove your idea with Principia or modern proofs.<br><br>3. Change angle ω that point P falls on main axis. What is the angele omega value now? Why? <br><br>4. When point P is apogee or perigee? Drag value ¦P,vb¦<b>of v</b>¦¦ to see you are right.<br><br>5. At which speed ¦borbit¦<b>orbit</b>¦¦ becomes circle?
                + start
                    -> started
