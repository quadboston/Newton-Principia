...
function completesSlidersCreation (){
    ...
    rg.vb.acceptPos = ( newPos, dragMove ) => {
        ...
        if( !(fconf.sappId === 'b1sec3prop17' && (
            ...
            //c cc( 'out of 17&&corr1,2' )
            //makes omega rotation,
            const pp = rg.P.pos;
        ...
        var momentumIncrease = increase *
            Math.abs( newSinOmega / sData.stashedOmega );
        var latus = sData.stashedLatus4slider *
                    momentumIncrease * momentumIncrease;
        var { e, fi, om, cosOmega, lat, r, eta, } =
            conics.innerPars2innerPars({
                r   : sData.stashedR,
                om  : newSinOmega,
                lat : latus,
                signCosOmega,
    ...
    rg.omegaHandle.acceptPos = ( newPos, dragMove ) => {
        ...
        var { e, fi, lat, r, eta, cosOmega, om, Kepler_v } =
            conics.innerPars2innerPars({
                r : rg.P.abs,
                lat : newLatus,
                om : newSinOmega,
