( function() {
    ...
    function initDragModel()
    {
        ...
        d8dp.lemmaFW({
            ...
            shows_book_picture: sDomF.shows_book_picture,
            dragPointDecoratorClasses              : fconf.dragPointDecoratorClasses,
            ...
            switch( arg.down_move_up ) {
                ...
                case 'move':
                        var newEy = ach.achieved -
                                arg.surfaceMoveFromDownToCurrent[1] * sconf.med2mod *
                                sDomF.ds2med();
            ...
            switch( arg.down_move_up ) {
                ...
                case 'move':
                        ...
                        var newDx = ach.achieved +
                                    ...
                                    arg.surfaceMoveFromDownToCurrent[0] * sconf.med2mod *
                                    sDomF.ds2med()
                                    / norm
                                    ;
