( function() {
    ...
    function addBookFunction()
    {
        ...
        repoConf[0] =
        {
            ...
            fun : at.mat.calculates_divided_differences_fw( xy ).calculate_polynomial,
        };
        //checks the job;
        //var dd = mat.calculates_divided_differences_fw( xy ).calculate_polynomial;
