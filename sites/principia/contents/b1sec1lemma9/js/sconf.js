(function(){
const { sconf, sf, nspaste, fconf, rg, toreg, tpelect, ssD, } =
...
function init_conf(){
    ...
    var medposOfModOrigin_x = pointA[0];
    var medposOfModOrigin_y = pointA[1];
    ...
    sf.shapesArray = [
        {
          isCurve: true,
          //todm: merge mainCurve and dcurve, cpivots and
          //cpivotsMedpos
          rgn : 'dcurve',
          cpivots: [
            [0, 0],
            //The bezier middle pivot is constrained in
            //"model-upcreate.js"
          ...
          initShapes: (gshape, rgn)=>{
            ...
            rg[rgn].cpivotsMedpos = rg[rgn].cpivots.map( cp =>
