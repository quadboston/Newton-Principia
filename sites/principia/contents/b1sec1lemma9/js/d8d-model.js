( function() {
    ...
    function initDragModel( lemmaD8D ){
        var modCurvPivots   = rg.dcurve.cpivotsMedpos;
        ...
        var wpoint              = rg.B;
        wpoint.dragDecorColor   = sDomF.rgid0arrc_2_rgba( 'given' );
        ...
        rgx2dragwraps({
            ...
            {
                var ach = arg.pointWrap.achievedtop;
                switch( arg.down_move_up ) {
                    case 'up':   ach.achieved = ssD.claimRatio;
                                 sDomF.shows_book_picture();
                    break;
                    case 'move':
                        sDomF.shows_book_picture();
                        ...
                        var newDy   = Math.min(
                                        Ey * claimRatio_max,
                                        startDy - arg.surfaceMoveFromDownToCurrent[1] * sconf.med2mod *
                                        sDomF.ds2med()
                                      );
        ...
        var wpoint              = rg.E;
        wpoint.dragDecorColor   = ns.haz( rg.E, 'pcolor' ) || sDomF.rgid0arrc_2_rgba( 'given' );
            ...
            finish_DownMoveUp : function( arg )
            {
                ...
                switch( arg.down_move_up ) {
                    ...
                    case 'move' :
                        ...
                        const yOffset = sDomF.ds2med() * sconf.med2mod * arg.surfaceMoveFromDownToCurrent[1] * yflip;
                ...
                finish_DownMoveUp : function( arg )
                {
                    ...
                    switch( arg.down_move_up ) {
                        ...
                        case 'move':
                             ...
                             var newCx = startCx + arg.surfaceMoveFromDownToCurrent[0] *
        ...
        wpoint.dragDecorColor   = ns.haz( rg.pivotPoint1, 'pcolor' ) || sDomF.rgid0arrc_2_rgba( 'proof' );
        wpoint.spinnerClsId     = 'pivotPoint1';
        rgx2dragwraps({
            achieved            : rg.dcurve.cpivotsMedpos[1].concat([]),
            pointWrap           : wpoint,
            cssClasses          : ['axis-x'],
            finish_DownMoveUp : function( arg )
            {
                var ach = arg.pointWrap.achievedtop;
                var pv = rg.dcurve.cpivotsMedpos.cpivots[1];
                switch( arg.down_move_up ) {
                    case 'down':
                    ...
                    case 'move':
                        ...
                        const xOffset = wwMed * sconf.med2mod * arg.surfaceMoveFromDownToCurrent[0];
        ...
        wpoint.dragDecorColor   = ns.haz( rg.pivotPoint2, 'pcolor' ) || sDomF.rgid0arrc_2_rgba( 'given' );
        wpoint.spinnerClsId        = 'pivotPoint2';

        rgx2dragwraps({
            achieved            : rg.dcurve.cpivotsMedpos[2].concat([]),
            pointWrap           : wpoint,
            cssClasses          : ['given','rotate'],
            finish_DownMoveUp : function( arg )
            {
                var ach = arg.pointWrap.achievedtop;
                var pv = rg.dcurve.cpivotsMedpos[2];
                switch( arg.down_move_up ) {
                    case 'up':   ach.achieved = pv.concat([]);
                                 sDomF.shows_book_picture();
                    break;
                    case 'move':
                        ...
                        var mx = wwMed * sconf.med2mod * arg.surfaceMoveFromDownToCurrent[0];
                        var my = wwMed * sconf.med2mod * arg.surfaceMoveFromDownToCurrent[1] * yflip;
