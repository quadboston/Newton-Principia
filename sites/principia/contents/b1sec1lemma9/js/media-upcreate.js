( function() {
    ...
    function media_upcreate___part_of_medupcr_basic (){
        ...
        //var medRemoteCurPivots =
        //ssD.modRemoteCurPivots.map( mod2medCustom );
        ...
        */
        ...
        function pos2pointy4lemma9( rgid, attrs, skipSVG, customSWidth, medPosKnown )
        {
            return pt              = toreg( rgid )();
            /*
            pt.rgid            = rgid;
            if( !medPosKnown ) {
                var pos         = rg[ rgid ].pos;
            ...
            */
            ...
            $$.$(pt.svgel).cls( cssClass + 'tp-' +  sDomF.rgid2low( rgid ) );
            return pt;
            */
        }
        //==========================================
