...
///adds to prop12 core code
function completesSlidersCreation_addon (){
    //=========================================================================
    // //\\ gamma slider
    //      for omega
    //=========================================================================
    ...
    rg.vSample.processOwnDownEvent = function() {
        ...
        sData.dShift_r              = Math.sqrt( dShift[0]*dShift[0] +
                                      dShift[1]*dShift[1] );
    ...
    rg.vSample.acceptPos = ( newPos, dragMove ) => {
        ...
        if( fconf.sappId === 'b1sec3prop17' && subessay == 'corollary2' ){
            ...
            // \\// corrects extreme values
            //--------------------------------
            var momentumIncrease = increase * Math.abs(
                newSinOmega / sData.stashedOmega_r );
        }
