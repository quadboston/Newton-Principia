...
function init_conf (){
    ...
    sf.medWidth = 282;
    sf.medHeight = 290;
    sf.medposOfModOrigin_x = 31.5;
    sf.medposOfModOrigin_y = 29;
    sf.mod2med = 1;
    //***************************************************************
    // \\// original picture dimensions for svg scene
    //***************************************************************
    ...
    Object.assign( sconf, {
        ...
        ctrlMedpos : [
            {x:sf.medposOfModOrigin_x, y: sf.medposOfModOrigin_y},
    ...
    //predefined-topic colors [R, G, B, Adefault, A-mouse-highlighted]
    {
        ...
        var tpel = nspaste( tpelect, {
            ...
            "circumscribed-rectangles":
                repo["circumscribed-rectangles"].concat(),
            "inscribed-rectangles":
                repo["inscribed-rectangles"].concat(),
            //[xx,  xx, xx, 0.1, 0.7],
    ...
    nspaste( originalPoints, {
       ctrl0 : {
        ...
        bottomSlider : {
            caption : 'bases count',
            pos : [ sf.medWidth * 0.5, sf.medHeight * 0.95 ],
            pcolor : tpel.legends,
            letterAngle : -90,
            letterRotRadius : 40,
            draggableX  : true,
        ...
        bottomSliderStart : {
            pos : [ sf.medWidth * 0.1, sf.medHeight * 0.95 ],
            undisplayAlways : true,
            doPaintPname : false,
            unscalable  : true,
        },
        bottomSliderEnd : {
            pos : [ sf.medWidth * 0.9, sf.medHeight * 0.95 ],
            undisplayAlways : true,
            doPaintPname : false,
            unscalable  : true,
        },
