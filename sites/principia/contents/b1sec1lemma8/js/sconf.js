{ let { ns, eachprop, haz, nspaste, fconf, sconf, tprepo,
        tpelect, } =
  window.b$l.atree({ ssFList : { init_conf : function(){

    //overrides "global", lemma.conf.js::sconf
    // opacity of items defined in originalPoints and linesArray below
    sconf.TP_OPACITY_LOW_POINT = 1;
    // applied to items defined in tpelect below
    ...
    var medWidth = 858; // size of svg div
    var medHeight = 566;
    var medposOfModOrigin_x = 166; // affect the shape of ACB
    var medposOfModOrigin_y = 63;
    ...
    // //\\ svg model colors
    //-----------------------------------
    var given = tprepo.given; // claim
    var proof   = tprepo.proof;
    var shadow  = tprepo.shadow; // colour of φ both point and label
    var result  = tprepo.result; // used only if sconf.rgShapesVisible === true
