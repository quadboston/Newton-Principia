( function() {
    ...
    function in_subessay_launch____amode2lemma( amodel2app_8_extraWork,  )
    {
        ...
        //------------------------------------------------
        // //\\ sets "undefined" flag
        //      for registry rg members with defined rgid,
        ...
        eachprop( rg, (prop,propname) => {
            ...
            //if( hazz( prop, 'rgid' ) && !has( prop, propname ) ) {
            //,or in case of 'undisplay'
            //if( hazz( prop, 'rgid' ) && !has( prop, 'undisplay' ) ) {
        ...
        if( sconf.SUBESSAY_TAB_RESETS_zoom_to_1 ){
            //:restores pole origin
            sconf.medposOfModOrigin_x =
                sconf.medposOfModOrigin_x_original;
            sconf.medposOfModOrigin_y =
                sconf.medposOfModOrigin_y_original;
            //restores scale
            ssF.newzoom2app(( rg.medzoom.value = 1 ));
        }
        sDomF.shows_book_picture( !sconf.MUSK_OUT_BOOK_PICTURE );
