...
//allowed to be overriden, what was this for?
...
function preparesDesktop({
    ...
    */
    ...
    if (draggerMove == null) {
        ...
        const frac = rootWnd.dividor.achievedtop.achieved;
    ...
    if (draggerMove == null) {
        ...
        //and don't update
        //rootWnd.dividor.achievedtop.achieved so that the desired ratio
        //is remembered.
        //Otherwise when decreasing both areas would decrease at a new ratio.
        //Note that rootWnd.dividor is still updated.
        const frac = rootWnd.dividor.achievedtop.achieved;
