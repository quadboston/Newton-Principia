( function() {
    var { sn, $$, haz, has, fmethods, eachprop, fconf, sconf, sDomN, rootWnd,
        stdMod, } = window.b$l.atree({ ssFList : { }, });
    rootWnd.buildsMobile     = buildsMobile;
    rootWnd.buildsNonMobile  = buildsNonMobile;
    return;
