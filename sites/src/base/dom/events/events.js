...
( function() {
    ...
    function fullResize()
    {
        ...
        haf( rootWnd, "start8finish_media8Ess8Legend_resize__upcreate" )(
            null, !!'doDividorSynch'
        );
    }
    ...
    function attachWeelToDomEl( domel$, ){
        ...
        function doHandle( ev ){
            stopAftershocks( ev );
            sDomF.shows_book_picture( !'not-moved' );
            ...
            sconf.medposOfModOrigin_x -= modpos[0] * increase;
            //+= means monitor Y flip
            sconf.medposOfModOrigin_y += modpos[1] * increase;
            rg['media-mover'].achievedtop.achieved = [
