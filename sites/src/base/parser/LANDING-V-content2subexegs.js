( function() {
    ...
    sDomF.rgid0arrc_2_rgba = rgid0arrc_2_rgba;
    ...
    function LANDING_V___loads_professorList8cont_8_buildsSubexegs(
        ...
        function cb__subessays2subexegs_8_doProcessSubexegs(){
            references.text = haz(
                  fconf.sappId2lemmaDef[ fconf.sappId ],
            ...
            subessays.forEach( function( singleSubessay ) {
                ...
                if( ess_instructions && ess_instructions[3] ) {
                    ...
                    essayHeader = stripp( essayHeader );
                    //===============================================================
                    // //\\ sets initial amode
                    //===============================================================
                ...
                eachprop( exAspects, ( exAspect, aspect_id ) => {
                    exAspect.subexegs.forEach( ( subex, subexId ) => {
                        ...
                        if( subexId === 0 ) {
                            ...
                            //**************************************************
                            // //\\ collects dragPointDecoratorClasses for
            ...
            function setMenu( leafId, mcat_id, essayHeader )
            {
                ...
                if( essayHeader.logic_phaseCaption &&
                    mcat_id === 'logic_phase' ) {
                    men.duplicates[ leafId ].caption =
                        essayHeader.logic_phaseCaption;
                }
            }
            //=======================================
            // \\// parses and sets menu
    ...
    ///todm: should be named rgid0arrc_2_rgba
    ...
    function rgid0arrc_2_rgba( rgid0arrc, makeOpacity1 )
    {
        if( typeof rgid0arrc === 'string' ) {
            var colorArray = haz( tpelect, rgid0arrc ) ||
                             //todm inconsistent: elected must be a
                             //master or nothing:
                             haz( tprepo, rgid0arrc );
        } else {
            var colorArray = rgid0arrc;
        }
