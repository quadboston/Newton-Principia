...
( function() {
    ...
    //todm this is removed and relies on
    //first demand call, PLATFORM_STARTED
    ...
    */
	...
	function runsMainCycle()
	{
        ...
        //}
        //todm: setInterval but why? This is not important for
        //now because time frames are not used,
		setTimeout( tframes.runsMainCycle, ANIMATION_THROTTLER );
	};
