...
const sn = window.b$l.sn;
const mat = sn( 'mat' );
const mcurve = sn( 'mcurve', mat );
...
function planeCurveDerivatives({
    ...
    //speed along q
    var vv      = [ (rplus[0] - rminus[0])*DDD2,
                    (rplus[1] - rminus[1])*DDD2, ];
    ...
    angleRV = cosOmega > 0 ? angleRV :
        angleRV > 0 ? PI-angleRV : -PI-angleRV;
