...
(function( window ){
    ...
    function unitVector(
        ...
        if( abs < 1e-100 && doDenullify ) {
            ...
            if( is3d ) {
                ...
                var unitVec = abs < 1e-40 ?
                    [0,0] : [ vector[0]/abs, vector[1]/abs ];
            }
        }
        var v2 = abs * abs;
        return {
            ...
            v2, //square of vector,
            unitVec,
            //vector,  //must be good extension to story
                       //original in this wrapper
        };
    }
    ...
    */
    ...
    function angleBetweenLines([
        ...
        var unitVector1 = p1_to_p2( vector1[0], vector1[1] ).unitVec;
        var unitVector2 = p1_to_p2( vector2[0], vector2[1] ).unitVec;
        const u10=unitVector1[0];
        const u11=unitVector1[1];
        const u20=unitVector2[0];
        const u21=unitVector2[1];
        var cos = u10*u20 + u11*u21;
        var sin = u10*u21 - u11*u20;
        return { __proto__:null,
                 cos, sin, angle:Math.atan2( sin, cos ) };
    }
})(window);