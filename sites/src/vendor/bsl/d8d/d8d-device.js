...
var mouseMoveCount = 0;
	...
	d8dp.deviceFW = function ( arg ){
        ...
        function addEvents()
        {
            ...
            //. todm: touch must provide event which then tested for
		...
		{
			var surfaceMoveFromDownToCurrent =
			[
            ...
            ///api:
            cbDownMoveUp(
                //total move which begins from down event
            ...
            return surfaceMoveFromDownToCurrent;
		};
        //*****************************************
		// \\// MOVE SUBROUTINES
        //*****************************************
