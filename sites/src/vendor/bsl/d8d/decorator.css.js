...
(function() {
    ...
    function creates_spinnerOwnCss(
        ...
        dragPointDecoratorClasses,  //"downward-css-callback", optional
        ...
        dragPointDecoratorClasses = dragPointDecoratorClasses || [''];
        CURSOR = spinnerCursorGrab || CURSOR;
        CURSOR_GRABBING = spinnerCursorGrabbed || CURSOR_GRABBING;
        var ret = '';
        // //\\ css /////////////////////////////////////////
        dragPointDecoratorClasses.forEach( function( dclass ) {
