( function() {
    ...
    function setModule()
    {
        ...
        stdMod.toogle_hideD8Dpoint  = toogle_hideD8Dpoint;
        ssF.createSliderPlaceholder_generic = createSliderPlaceholder_generic;
        pos2pointy      = ssF.pos2pointy;
        pointies2line   = ssF.pointies2line;
    }

    function createSliderPlaceholder_generic({
        magnit,
        sliderCaption,
        cssClsKey,
        max_magnit,
