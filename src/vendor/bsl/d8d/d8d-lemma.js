...
(function(){
const {ns, sn, d8dp, has, haz, $$, dpdec, fconf,} = window.b$l.nstree();
...
function lemmaFW({
    ...
    var { givenClickEvent, eventPos_2_surfacePos } = d8dp.deviceFW({
        ...
        //       dragSurface points, processes "finish_DownMoveUp"-like calls,
    ...
    function movesAndFindsHandle( rootEvent ){
        ...
        //very good for debug:
        //c cc( spinnerCandidate.pointWrap.shpid  );
        ...
        //if( spinnerCandidate.pointWrap.shpid === 'P' )
        //c cc( spinnerCandidate.pointWrap.shpid, decPoint );

        if( decPoint &&
            spinnerCandidate.pointWrap.shpid !== 'media-mover'
        ){
    ...
    function pointWrap_2_dragWraps( api ){
        ...
        var finish_DownMoveUp    = api.finish_DownMoveUp; //to be set at point-def.
        //:optional
    ...
    function cbDownMoveUp(
        ...
        switch( down_move_up )
        {
            case 'down':
                ...
                elected_dragWrap = spinnerCandidate || findDraggee(
                        point_on_dragSurf,
                        dragWraps,
