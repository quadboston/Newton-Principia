<?php
    ...
    */
    ...
    //=====================================================
    $appname = 'app';
    //moves two levels up into app-main-root
    $relevel_production_root = '../../';
    $unleveled_prod_path = 'prod';
    $prod_folder = $relevel_production_root . $unleveled_prod_path;
    ...
    $html_src_path   = $unleveled_prod_path . '/' . $appname . '.src.js'; //for landing file
    ...
    function spawn_landing_file( $content, $regex, $links,
        ...
        $new_path = $relevel_production_root . $folderto;
        if( $fileto ) {
            $new_path .= '/' . $fileto;
        }
